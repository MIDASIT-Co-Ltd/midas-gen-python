...
class Boundary:
    ...
    @classmethod
    def create(cls):
        """Creates Boundary elements in MIDAS GEN NX"""
    ...
    @classmethod
    def delete(cls):
        """Delets Boundary elements from MIDAS GEN NX and Python"""
        cls.Support.delete()
    ...
    @classmethod
    def sync(cls):
        """Sync Boundary elements from MIDAS GEN NX to Python"""
        cls.Support.sync()
    ...
    class Support:
        ...
        @staticmethod
        def create():
            """Creates Supports in MIDAS GEN NX"""
            MidasAPI("PUT","/db/cons",Boundary.Support.json())
            
        @staticmethod
        def get():
            """Get the JSON of Supports from MIDAS GEN NX"""
            return MidasAPI("GET","/db/cons")
        
        @staticmethod
        def sync():
            """Sync Supports from MIDAS GEN NX to Python"""
        ...
        @staticmethod
        def delete():
            """Delete Supports from MIDAS GEN NX and Python"""
